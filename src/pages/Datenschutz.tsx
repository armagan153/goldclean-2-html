      ...
      <section className="section-padding">
        <div className="container-custom max-w-4xl">
          ...
          <div className="prose max-w-none text-muted-foreground">
            ...
            <h5 className="font-semibold mt-4 mb-2 text-foreground">Wie erfassen wir Ihre Daten?</h5>
            <p className="mb-4">
            ...
            <h5 className="font-semibold mt-4 mb-2 text-foreground">Wofür nutzen wir Ihre Daten?</h5>
            <p className="mb-4">
              Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.
            </p>

            <h5 className="font-semibold mt-4 mb-2 text-foreground">Welche Rechte haben Sie bezüglich Ihrer Daten?</h5>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mt-8 mb-4 text-foreground">3. Allgemeine Hinweise und Pflichtinformationen</h3>

            <h4 className="text-lg font-semibold mt-6 mb-3 text-foreground">Datenschutz</h4>
            <p className="mb-4">
              Die Betreiber dieser Seiten nehmen den Schutz Ihrer persönlichen Daten sehr ernst. Wir behandeln Ihre personenbezogenen Daten vertraulich und entsprechend den gesetzlichen Datenschutzvorschriften sowie dieser Datenschutzerklärung.
            </p>

            <h4 className="text-lg font-semibold mt-6 mb-3 text-foreground">Hinweis zur verantwortlichen Stelle</h4>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mt-8 mb-4 text-foreground">4. Datenerfassung auf dieser Website</h3>

            <h4 className="text-lg font-semibold mt-6 mb-3 text-foreground">Cookies</h4>
            <p className="mb-4">
              Unsere Internetseiten verwenden so genannte „Cookies". Cookies sind kleine Textdateien und richten auf Ihrem Endgerät keinen Schaden an. Sie werden entweder vorübergehend für die Dauer einer Sitzung (Session-Cookies) oder dauerhaft (permanente Cookies) auf Ihrem Endgerät gespeichert. Session-Cookies werden nach Ende Ihres Besuchs automatisch gelöscht. Permanente Cookies bleiben auf Ihrem Endgerät gespeichert, bis Sie diese selbst löschen oder eine automatische Löschung durch Ihren Webbrowser erfolgt.
            </p>

            <h4 className="text-lg font-semibold mt-6 mb-3 text-foreground">Kontaktformular</h4>
            <p className="mb-4">
              Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben aus dem Anfrageformular inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und für den Fall von Anschlussfragen bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.
            </p>

            <h3 className="text-xl font-semibold mt-8 mb-4 text-foreground">5. Plugins und Tools</h3>

            <h4 className="text-lg font-semibold mt-6 mb-3 text-foreground">Google Web Fonts</h4>
            <p className="mb-4">
              Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Web Fonts, die von Google bereitgestellt werden. Beim Aufruf einer Seite lädt Ihr Browser die benötigten Web Fonts in ihren Browsercache, um Texte und Schriftarten korrekt anzuzeigen.
            </p>

            <h4 className="text-lg font-semibold mt-6 mb-3 text-foreground">Google Maps</h4>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mt-8 mb-4 text-foreground">6. Eigene Dienste</h3>

            <h4 className="text-lg font-semibold mt-6 mb-3 text-foreground">Umgang mit Bewerberdaten</h4>
            <p className="mb-4">
